...
{ 
        ...
        text << "<html>"
            << "<body>"
            << "Copyri <br />" 
            << "<a href=\"aaaaaaaaaaaaaaaaaaaaaaaa/\">Slic3r</a> is licensed under the "
            << "<a href=\"htaaaaaaaaaaaaaaaaaaaaaaaaaaa.html\">GNU Affero General Public License, version 3</a>."
            << "<br /><br /><br />"
            ...
            << "Manuaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaamunity. <br />"
            << "Slaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaels, <a href=\"http://www.famfamfam.com/lab/icons/silk/\">Silk Icon Set</a> designed by Mark James. "
            << "<br /><br />"
